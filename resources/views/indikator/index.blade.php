    ...
    <div class="rounded-2xl bg-gradient-to-br from-bps-green-600 to-bps-green-500 p-6 md:p-8 text-white relative overflow-hidden">
        ...
        <div class="relative">
            ...
            <div class="mt-5">
                ...
                class="inline-flex items-center gap-2.5 px-4 py-2.5 rounded-lg bg-white text-bps-green-700 text-sm font-semibold hover:bg-bps-green-50 active:scale-[0.98] transition shadow-sm">
                    
                    {{-- Icon Upload (Disesuaikan posisinya biar pas sejajar teks) --}}
                    <svg class="w-4 h-4 shrink-0 translate-y-[0.5px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
